...
export const ADAPTER_PENDING = Symbol('adapter request pending');
export const ADAPTER_ERROR = Symbol('adapter network error');
export const ADAPTER_BAD_REQUEST = Symbol('adapter bad request');
export const ADAPTER_TIMEOUT = Symbol('adapter timeout');
